...
namespace ZeroGUI
{
	namespace Colors
	{
		...
		flinearcolor Window_Background = { 0.212f, 0.212f, 0.212f, 0.788f };
		flinearcolor Window_Header = { 0.412f, 0.412f, 0.412f, 0.788f };

		flinearcolor Button_Idle = { 0.412f, 0.412f, 0.412f, 0.788f };
		flinearcolor Button_Hovered = { 0.412f, 0.412f, 0.412f, 0.788f };
		flinearcolor Button_Active = { 0.412f, 0.412f, 0.412f, 0.788f };

		flinearcolor Checkbox_Idle = { 0.412f, 0.412f, 0.412f, 0.788f };
		flinearcolor Checkbox_Hovered = { 0.460f, 0.460f, 0.460f, 0.788f };
		flinearcolor Checkbox_Enabled = { 0.5f, 0.5f, 0.5f, 0.788f };

		flinearcolor Combobox_Idle = { 0.412f, 0.412f, 0.412f, 0.788f };
		flinearcolor Combobox_Hovered = { 0.412f, 0.412f, 0.412f, 0.788f };
		flinearcolor Combobox_Elements = { 0.412f, 0.412f, 0.412f, 0.788f };

		flinearcolor Slider_Idle = { 0.412f, 0.412f, 0.412f, 0.788f };
		flinearcolor Slider_Hovered = { 0.412f, 0.412f, 0.412f, 0.788f };
		flinearcolor Slider_Progress = { 0.412f, 0.412f, 0.412f, 0.788f };
		flinearcolor Slider_Button = { 0.412f, 0.412f, 0.412f, 0.788f };

		flinearcolor ColorPicker_Background = { 0.412f, 0.412f, 0.412f, 0.788f };
